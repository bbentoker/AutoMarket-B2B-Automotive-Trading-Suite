...
docker build `
  ...
  --build-arg VITE_DASHBOARD_URL=$DASHBOARD_URL `
  -t $DOCKER_IMAGE .
...
Write-Host "- Dashboard URL: $DASHBOARD_URL" -ForegroundColor Yellow
