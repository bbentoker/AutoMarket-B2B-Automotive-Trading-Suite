    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[9999] p-4">
      <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-hidden shadow-2xl">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="text-2xl font-bold text-gray-900">Terms of Service</div>
          <button
            onClick={onClose}
          ...
          <div className="prose prose-gray max-w-none">
            <div className="mb-6">
              ...
              <p className="text-gray-700">
                ...
                By accessing or using our services via www.automarket.example.com (the "Platform"), you agree to be bound by these Terms.
              </p>
            </div>

            <section className="mb-6">
              <div className="text-lg font-semibold text-gray-900 mb-3">1. Definitions</div>
            ...
            <section className="mb-6">
              <div className="text-lg font-semibold text-gray-900 mb-3">2. Eligibility & Registration</div>
              <ul className="list-disc list-inside ml-4 text-gray-700 space-y-1">
            ...
            <section className="mb-6">
              <div className="text-lg font-semibold text-gray-900 mb-3">3. Vehicle Reservations & Offers</div>
              <ul className="list-disc list-inside ml-4 text-gray-700 space-y-1">
            ...
            <section className="mb-6">
              <div className="text-lg font-semibold text-gray-900 mb-3">4. Pricing & Payment Terms</div>
              <ul className="list-disc list-inside ml-4 text-gray-700 space-y-1">
            ...
            <section className="mb-6">
              <div className="text-lg font-semibold text-gray-900 mb-3">5. Vehicle Information & Inspections</div>
              <ul className="list-disc list-inside ml-4 text-gray-700 space-y-1">
            ...
            <section className="mb-6">
              <div className="text-lg font-semibold text-gray-900 mb-3">6. Delivery & Logistics</div>
              <ul className="list-disc list-inside ml-4 text-gray-700 space-y-1">
            ...
            <section className="mb-6">
              <div className="text-lg font-semibold text-gray-900 mb-3">7. User Responsibilities</div>
              <ul className="list-disc list-inside ml-4 text-gray-700 space-y-1">
            ...
            <section className="mb-6">
              <div className="text-lg font-semibold text-gray-900 mb-3">8. Intellectual Property</div>
              <ul className="list-disc list-inside ml-4 text-gray-700 space-y-1">
            ...
            <section className="mb-6">
              <div className="text-lg font-semibold text-gray-900 mb-3">9. Limitation of Liability</div>
              <ul className="list-disc list-inside ml-4 text-gray-700 space-y-1">
            ...
            <section className="mb-6">
              <div className="text-lg font-semibold text-gray-900 mb-3">10. Governing Law & Jurisdiction</div>
              <ul className="list-disc list-inside ml-4 text-gray-700 space-y-1">
            ...
            <section className="mb-6">
              <div className="text-lg font-semibold text-gray-900 mb-3">11. Changes to the Terms</div>
              <ul className="list-disc list-inside ml-4 text-gray-700 space-y-1">
            ...
            <section className="mb-6">
              <div className="text-lg font-semibold text-gray-900 mb-3">12. VAT Compliance & Responsibility</div>
              <ul className="list-disc list-inside ml-4 text-gray-700 space-y-1">
