          ...
          <div className="prose prose-gray max-w-none">
            <div className="mb-6">
              <p className="text-sm text-gray-600 mb-2">
                ...
                <strong>Website:</strong> <a href="https://buy.automarket.example.com" className="text-blue-600 hover:underline">https://buy.automarket.example.com</a>
              </p>
            ...
            <section className="mb-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">2. What Data We Collect</h3>
              <p className="text-gray-700 mb-3">
                We may collect and process the following categories of personal and business data:
              </p>
              
              <div className="mb-4">
                <h4 className="font-medium text-gray-900 mb-2">2.1 Account & Identity Information</h4>
              ...
              <div className="mb-4">
                <h4 className="font-medium text-gray-900 mb-2">2.2 Platform Usage</h4>
                <ul className="list-disc list-inside ml-4 text-gray-700">
              ...
              <div className="mb-4">
                <h4 className="font-medium text-gray-900 mb-2">2.3 Financial Information</h4>
                <ul className="list-disc list-inside ml-4 text-gray-700">
            ...
            <section className="mb-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">4. Legal Basis for Processing</h3>
            ...
            <section className="mb-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">5. Data Sharing</h3>
            ...
            <section className="mb-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">6. International Transfers</h3>
              <p className="text-gray-700">
            ...
            <section className="mb-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">8. Your Rights Under GDPR</h3>
            ...
            <section className="mb-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">9. Cookies and Tracking Technologies</h3>
            ...
            <section className="mb-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">10. Data Security</h3>
            ...
            <section className="mb-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">11. Changes to This Privacy Policy</h3>
              <p className="text-gray-700">
            ...
            <section className="mb-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">12. Complaints</h3>
              <p className="text-gray-700 mb-3">
